...
- CloudCompare | https://www.cloudcompare.org/
  - Cloudcompare was used to both convert point-cloud data to another format; in our case PLY, and separating different parts of the data to their own objects (segmentation). Cloudcompare had many plugins which turned out to be useful in this.
...
- Point Cloud Unity Plugin | https://ccom.unh.edu/vislab/tools/point_cloud_plugin/
  - This Plugin was originally our other option for bringing point cloud data into Unity. After trying to get it to work with Unity and our data, we were not able to make it work as intended, which is why we decided to use above mentioned Pcx instead.
